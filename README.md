...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p aec5ea47-67cd-4e32-8053-f2606e0f3b69
```

> `aec5ea47-67cd-4e32-8053-f2606e0f3b69` is the password of the certificate, you can change it to any password you want.
